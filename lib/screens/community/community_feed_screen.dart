...
class _CommunityFeedScreenState extends State<CommunityFeedScreen> {
  ...
  Future<void> _fetchPosts() async {
    final posts = await _socialMediaService.fetchPosts(zipCode: _zipCode);
    setState(() {
      _posts = posts;
    });
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              final zipCode = await _showZipCodeDialog();
              if (zipCode != null) {
                setState(() {
                  _zipCode = zipCode;
                });
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () => _donateToArtist(post['artist_id']),
                            ),
                          ],
                        ),
                      ],
  ...
  Future<int?> _showZipCodeDialog() async {
    int? zipCode;
    await showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          title: const Text('Filter by ZIP Code'),
          content: TextField(
